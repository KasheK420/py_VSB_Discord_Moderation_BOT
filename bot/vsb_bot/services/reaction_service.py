...
class ReactionService(Service):
    ...
    def __register_commands__(self):
        ...
        @self.commands.command(name="react_text", description="Get a text reaction for a specific word.")
        @app_commands.describe(word="The word to trigger a text response.")
        ...
        @self.commands.command(name="react_gif", description="Get a GIF reaction for a specific word.")
        @app_commands.describe(word="The word to trigger a GIF response.")
        async def react_gif(interaction: discord.Interaction, word: str):
            ...
            try:
                ...
                await interaction.response.send_message(
                    content="An error occurred while fetching the GIF.", ephemeral=True
                )
