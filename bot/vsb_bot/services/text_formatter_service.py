...
class TextFormatterService(Service):
    def __register_commands__(self):
        ...
        @self.commands.command(
            name="create_embed",
            description="Create a custom embedded message (Admin only).",
        )
        ...
        async def create_embed(
            ...
            try:
                ...
                await interaction.response.send_message(
                    "Failed to create the embed. Check the details and try again.",
                    ephemeral=True,
                )
        ...
        async def code_snippet(interaction: discord.Interaction, language: str, code: str):
            ...
            try:
                ...
                await interaction.response.send_message(
                    "Failed to create the code snippet. Try again later.",
                    ephemeral=True,
                )
