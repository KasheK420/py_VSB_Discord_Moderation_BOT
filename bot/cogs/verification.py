...
class VerificationCog(commands.Cog):
    ...
    async def setup_verification(self, interaction: Interaction):
        if not self.onboarding:
            ...
            return await interaction.response.send_message("❌ Onboarding service not available.", ephemeral=True)
        ...
        try:
            ...
            await interaction.followup.send(f"❌ Failed to post verification message: {e}", ephemeral=True)
